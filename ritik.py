...
def bill_area():
    if nameEntry.get()==''or phoneEntry.get()=='':
        ...
        messagebox.showerrror('Error','no products are selected')
    elif cosmeticpriceEntry.get()=='0 Rs' and grocerypriceEntry.get()=='0 Rs' and drinkspriceEntry.get()=='0 Rs':
        messagebox.showerrror('Error','no products are selected')
    else:
        textarea.delete(1.0,END)

        textarea.insert(END,'\t\t**Welcome Cusstomer**\n')
        textarea.insert(END,f'\nBill Number:{billnumber}\n')
        textarea.insert(END,f'\nCustomer Name:{nameEntry.get()}\n')
        textarea.insert(END,f'\nCustomer Phone Number:{nameEntry.get()}\n')
        textarea.insert(END,'\n=======================================================')
        ...
        if hairsprayEntry.get()!='0':
            textarea.insert(END,f'\nHair Spray\t\t\t{hairsprayEntry.get()}\t\t\t{soapprice}Rs')
        ...
        if cocaEntry.get()!='0':
            textarea.insert(END,f'\nCoca\t\t\t{cocaEntry.get()}\t\t\t{cocaprice} Rs') 
...
def total():
    ...
    global maazaprice,pepsiprice,spriteprice,frootiprice,dewprice,cocaprice
    global totalbill
    ...
    hairgelprice=int(hairgelEntry.get())*160
    ...
    grocerytax=totalcosmeticprice*0.05
    grocerytaxEntry.delete(0,END)
    ...
    cocaprice=int(cocaEntry.get())*60

    totaldrinksprice=maazaprice+pepsiprice+spriteprice+dewprice+frootiprice+cocaprice
    drinkspriceEntry.delete(0,END)
    drinkspriceEntry.insert(0,str(totaldrinksprice)+'Rs')
    drinkstax=totaldrinksprice*0.08
    colddrinkstaxEntry.delete(0,END)
    colddrinkstaxEntry.insert(0,str(drinkstax)+'Rs')
...
headingLabel=Label(root,text='retail billing system',font=('times new roman',30),bg='gray20',fg='gold',bd=12,relief=GROOVE)
...
facecreamLabel.grid(row=1,column=0,pady=9)

facecreamEntry=Entry(cosmeticsFrame,font=('times new roman',15,'bold'),width=10,bd=5)
facecreamEntry.grid(row=1,column=1,pady=9)
facecreamEntry.insert(0,0)

facewashLabel=Label(cosmeticsFrame,text='Facewash',font=('times new roman',15,'bold'),bg='gray20',fg='white')
facewashLabel.grid(row=2,column=0,pady=9)

facewashEntry=Entry(cosmeticsFrame,font=('times new roman',15,'bold'),width=10,bd=5)
facewashEntry.grid(row=2,column=1,pady=9)
facewashEntry.insert(0,0)

hairsprayLabel=Label(cosmeticsFrame,text='Hairspray',font=('times new roman',15,'bold'),bg='gray20',fg='white')
hairsprayLabel.grid(row=3,column=0,pady=9)

hairsprayEntry=Entry(cosmeticsFrame,font=('times new roman',15,'bold'),width=10,bd=5)
hairsprayEntry.grid(row=3,column=1,pady=9)
hairsprayEntry.insert(0,0)

hairgelLabel=Label(cosmeticsFrame,text='Hairgel',font=('times new roman',15,'bold'),bg='gray20',fg='white')
hairgelLabel.grid(row=4,column=0,pady=9)


hairgelEntry=Entry(cosmeticsFrame,font=('times new roman',15,'bold'),width=10,bd=5)
hairgelEntry.grid(row=4,column=1,pady=9)
hairgelEntry.insert(0,0)

bodylotionLabel=Label(cosmeticsFrame,text='Bodylotion',font=('times new roman',15,'bold'),bg='gray20',fg='white')
bodylotionLabel.grid(row=5,column=0,pady=9)
...
daalLabel.grid(row=2,column=0,pady=9,sticky='W')
...
drinksFrame=LabelFrame(productsFrame,text='Drinks',font=('times new roman',15,'bold'),fg='gold',bd=8,relief=GROOVE,bg='gray20')
drinksFrame.grid(row=0,column=2)

maazaLabel=Label(drinksFrame,text='Maaza',font=('times new roman',15,'bold'),bg='gray20',fg='white')
maazaLabel.grid(row=0,column=0,pady=9,sticky='W')
...
dewLabel.grid(row=3,column=0,pady=9,sticky='W')
...
frootiLabel.grid(row=4,column=0,pady=9,sticky='W')
...
cocaLabel=Label(drinksFrame,text='Coca',font=('times new roman',15,'bold'),bg='gray20',fg='white')
cocaLabel.grid(row=5,column=0,pady=9,sticky='W')

cocaEntry=Entry(drinksFrame,font=('times new roman',15,'bold'),width=10,bd=5)
cocaEntry.grid(row=5,column=1,pady=9,padx=10)
cocaEntry.insert(0,0)
...
drinkspriceLabel=Label(billmenuFrame,text='Drinks',font=('times new roman',14,'bold'),bg='gray20',fg='white')
...
colddrinkstaxLabel=Label(billmenuFrame,text='Drinks Tax',font=('times new roman',14,'bold'),bg='gray20',fg='white')
...
totalButton=Button(buttonFrame,text='Total',font=('arial',16,'bold'),bg='gray20',bd=5,width=8,fg='white',pady=10,command=total)
totalButton.grid(row=0,column=0,pady=20,padx=5)

billButton=Button(buttonFrame,text='Bill',font=('arial',16,'bold'),bg='gray20',bd=5,width=8,fg='white',pady=10,command=bill_area)
billButton.grid(row=0,column=1,pady=20,padx=5)

emailButton=Button(buttonFrame,text='E-mail',font=('arial',16,'bold'),bg='gray20',bd=5,width=8,fg='white',pady=10,command=send_email)
emailButton.grid(row=0,column=2,pady=20,padx=5)

printButton=Button(buttonFrame,text='Print',font=('arial',16,'bold'),bg='gray20',bd=5,width=8,fg='white',pady=10,command=print_bill)
printButton.grid(row=0,column=3,pady=20,padx=5)

clearButton=Button(buttonFrame,text='Clear',font=('arial',16,'bold'),bg='gray20',bd=5,width=8,fg='white',pady=10,command=clear)
